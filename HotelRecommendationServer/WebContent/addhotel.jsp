...
<div id="page" align="center">
	...
	<div id="content">
		<div class="post">
		  ...
		  <a href="viewHotel.jsp">View Hotel</a>
				
                <form name="form" action="AddHotelServlet" method="post" onsubmit="return validateHotel(form);">
	
		<table width="40%" border="0" cellspacing="2" 
			cellpadding="2" style="margin-top: 10px">
			<thead>
				<tr>
					<th colspan="2" style="font-size: 22px">Add Hotel</th> 
				</tr>
			</thead>
			<tbody>
				<tr>
