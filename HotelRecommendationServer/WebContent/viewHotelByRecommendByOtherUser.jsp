...
String swimmingPool=request.getParameter("swimming");
String parking=request.getParameter("parking");
String laoundry=request.getParameter("laoundry");
double lat=Double.parseDouble(request.getParameter("lat"));
double longi=Double.parseDouble(request.getParameter("long"));
 /* int userId=Integer.parseInt(request.getParameter("userId")); */


HotelDataBaseHelper hotelDataBaseHelper = new HotelDataBaseHelper();
ArrayList<HotelBean> hotelBeanList = hotelDataBaseHelper.fetchAllHotelInfoByCriteriaAndRecomByOtherUser(swimmingPool, laoundry, parking, lat, longi, "k");
